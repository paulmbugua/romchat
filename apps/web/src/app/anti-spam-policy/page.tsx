...
const sections = [
  {
    ...
    "body": "Members may not send repeated unsolicited messages, commercial ads, phishing links, or automated romantic scripts."
  },
  {
    "title": "Enforcement",
    "body": "Spam reports may trigger throttling, account review, blocking, suspension, or permanent removal."
  }
];
    ...
    <main className="min-h-screen bg-[#09050b] px-4 py-8 text-white">
      <div className="mx-auto max-w-4xl">
        ...
        <section className="mt-6 rounded-[32px] border border-white/10 bg-white/[0.04] p-6 sm:p-8">
          ...
          <h1 className="mt-5 text-4xl font-black sm:text-6xl">Anti-Spam Policy</h1>
          <p className="mt-4 max-w-3xl leading-8 text-white/70">RomChat prohibits spam, fake outreach, mass messaging, bot activity, and deceptive promotion.</p>
        </section>
