# Google Stitch Prompt: RomChat Dating App UX Redesign

Design a premium, beautiful, romance-first mobile dating and chatting app called RomChat. The app should feel as simple and addictive as Tinder, but softer, more feminine, and more emotionally intimate. Use bold hot pink, coral, blush, yellow-gold, white, and deep plum/black for contrast. Avoid busy dashboards. The first screen must be a clean swipe experience with one large photo card, minimal top brand bar, and thumb-friendly actions.
...
- Pay tokens for Super Like/Top Like.
- Pay tokens to undo an accidental pass.
- Pay tokens to extend an expiring match.
- Sell Gold/Platinum subscriptions.
- Sell boosts/spotlight placement.
- Sell virtual gifts such as rose, coffee, spotlight note.

UX requirements:
- Main screen must not feel busy.
- Use one primary action per card.
- Keep bottom device safe area clear.
- Make all paid moments feel romantic, valuable, and transparent.
- Never hide safety/report actions.
- Use modern rounded cards, rich photos, tasteful gradients, crisp contrast, and large readable type.
- Produce responsive mobile layouts for small Android phones and large iPhones.
